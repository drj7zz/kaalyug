  ...
  return (
    <section id="ecosystem" className="w-[min(92%,1100px)] mx-auto mt-[25px] grid grid-cols-1 md:grid-cols-2 gap-[15px]">
      <div className="glass p-[30px] rounded-[24px]">
        <h2 className="text-[23px] leading-[1.1] font-bold">
          Open source
          <br />
          by default.
        </h2>
        ...
        <div className="mt-[20px] p-[15px] flex justify-between items-center rounded-[15px] bg-[rgba(255,255,255,0.035)] border border-[rgba(255,255,255,0.08)]">
          <div>
            <strong className="block text-[11px] font-bold">kaalyug-marketplace</strong>
      ...
      <div className="glass p-[30px] rounded-[24px]">
        ...
        <div className="mt-[20px] p-[15px] flex justify-between items-center rounded-[15px] bg-[rgba(255,255,255,0.035)] border border-[rgba(255,255,255,0.08)]">
          <div>
            <strong className="block text-[11px] font-bold">YugCoin Wallet</strong>
