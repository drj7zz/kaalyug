...
export default function Wallet() {
  ...
  return <section id="wallet" className="w-[min(92%,1100px)] mx-auto mt-[90px]">
    <div className="mb-[22px]"><div className="text-[#62d9c5] text-[9px] font-semibold tracking-[0.12em]"><i className="fa-solid fa-bolt mr-1"></i>NATIVE ECOSYSTEM WALLET</div><h2 className="mt-[8px] text-[34px] tracking-[-1.8px] font-bold">YugCoin</h2><p className="max-w-[560px] mt-[10px] text-[#7d7f89] text-[11px] leading-[1.7]">Your YugCoin account and activity are loaded securely from the live wallet service.</p></div>
    {!session ? <div className="glass p-[28px] rounded-[25px] text-center"><p className="text-[#aeb0bc] text-sm"><i className="fa-solid fa-lock text-[#ff8799] mr-2"></i>Sign in with your YugCoin account to view your live wallet.</p><Link to="/yugcoin/login" className="inline-block mt-4 auth-button btn-hover w-auto px-6"><i className="fa-solid fa-right-to-bracket mr-2"></i>YugCoin login</Link><p className="mt-3 text-[#858691] text-[10px]">Marketplace login and YugCoin login are separate accounts.</p></div> : <div className="grid grid-cols-1 md:grid-cols-[1.15fr_0.85fr] gap-[15px]">
