    ...
    <footer className="py-[35px] mt-[80px] border-t border-[rgba(255,255,255,0.07)]">
      <div className="w-[min(92%,1100px)] mx-auto flex flex-col md:flex-row items-center justify-between gap-[15px] md:gap-[0]">
        <div className="text-center md:text-left">
          <strong className="text-[13px] font-bold"><i className="fa-solid fa-code text-[#71dfcc] mr-2"></i>KAALYUG</strong>
        ...
        <div className="flex items-center gap-[20px]">
          ...
          <a href="/wallet" className="btn-hover text-[#9b9da8] no-underline text-[11px] hover:text-[#71dfcc] transition-colors flex items-center gap-[6px]">
